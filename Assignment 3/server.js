...
app.use((req, res, next) => {
  ...
  // ensure message exists for views that expect it
  res.locals.message = (res.locals.error && res.locals.error.length)
    ? res.locals.error[0]
    : null;
  next();
});
...
// DATABASE CONNECTION
// =======================
mongoose.connect("mongodb://localhost:27017/horse_shop");
...
// Friendly routes - using new design
app.get("/login", (req, res) => res.render("login-new", { layout: "navbar-layout", title: "Login" }));
app.get("/register", (req, res) => res.render("register-new", { layout: "navbar-layout", title: "Register" }));
// Friendly logout alias
...
app.get("/cart", (req, res) => {
  ...
  res.render("cart-new", { layout: "navbar-layout", title: "Cart", cartItems: cartItems });
});
...
app.get("/checkout", (req, res) => {
  ...
  res.render("checkout", { layout: "navbar-layout", title: "Checkout", cart });
});

app.post("/checkout", (req, res) => {
  // Logic to save order to DB would go here
  req.session.cart = []; // Clear Cart
  res.render("success", { layout: "navbar-layout", title: "Success" });
});
...
app.get("/admin", async (req, res) => {
  ...
  // Using new admin layout
  res.render("admin-new", { layout: "navbar-layout", title: "Admin Panel", products });
});

// Create Product Form
app.get("/admin/product/create", (req, res) => {
  res.render("admin/form", { layout: "navbar-layout", title: "Add Product", product: null });
});
...
app.get("/admin/product/edit/:id", async (req, res) => {
  ...
  res.render("admin/form", { layout: "navbar-layout", title: "Edit Product", product });
});
...
app.get("/contact", (req, res) => {
  res.render("contact-new", { layout: "navbar-layout", title: "Contact Us" });
});

app.get("/about", (req, res) => {
  res.render("contact-new", { layout: "navbar-layout", title: "About Us" });
});
